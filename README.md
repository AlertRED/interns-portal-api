...
### API's list:
+ [Auth](https://github.com/2UP/interns-portal-api/blob/docs-v1/docs/auth.md)
+ [User](https://github.com/2UP/interns-portal-api/blob/docs-v1/docs/user.md)
+ [Me (current user)](https://github.com/2UP/interns-portal-api/blob/docs-v1/docs/me.md)
